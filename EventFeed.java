...
class EventFeed {
	 ...
	 @BeforeEach   // Correct annotation for JUnit 5
	    public void setUp() throws InterruptedException {
	        ...
	        WebElement feed = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div/aside/a[2]")));
	        feed.click();
	    }
	    ...
	    public void testUnlikeButtonVisibility() {
	        ...
	        // Wait for the presence of the Unlike button
	        WebElement unlikeButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div/div/div[1]/button[2]")));

	        // Assert that the Unlike button is visible
	        assertTrue("Unlike button is not visible on the homepage", unlikeButton.isDisplayed());
	    }
	    @Test
	    public void testlikeButtonVisibility() {
	        

	        // Wait for the presence of the Unlike button
	        WebElement unlikeButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div/div/div[1]/button[1]")));

	        // Assert that the Unlike button is visible
	        assertTrue("like button is not visible on the homepage", unlikeButton.isDisplayed());
	    }
	    @Test
	    public void testPostButtonVisibility() {
	        

	        // Wait for the presence of the Post button
	        WebElement postButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div/div/div[1]/div[2]/form/button")));

	        // Assert that the Post button is visible
	        assertTrue("Post button is not visible on the homepage", postButton.isDisplayed());
	    }
