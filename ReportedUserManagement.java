...
class ReportedUserManagement {
	 ...
	 @BeforeEach   // Correct annotation for JUnit 5
	    public void setUp() throws InterruptedException {
	        ...
	        WebElement usermanage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div/aside/a[3]")));
	        usermanage.click();
	    }
	 @Test
	    ...
	    @Test
	    public void testviewButtonIsDisplayed()throws InterruptedException {
	     	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	        WebElement viewButton = driver.findElement(By.xpath("/html/body/div/div/div/table/tbody/tr[1]/td[4]/button[1]"));
	        assertTrue(viewButton.isDisplayed(), "view button should be visible.");
	     }
	    @Test
	    public void testsuspendButtonIsDisplayed()throws InterruptedException {
	     	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	        WebElement suspendButton = driver.findElement(By.xpath("/html/body/div/div/div/table/tbody/tr[1]/td[4]/button[2]"));
	        assertTrue(suspendButton.isDisplayed(), "delete button should be visible.");
	     }
	    @Test
	    public void testissuewarningIsDisplayed()throws InterruptedException {
	     	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	        WebElement warningButton = driver.findElement(By.xpath("/html/body/div/div/div/table/tbody/tr[1]/td[4]/button[3]"));
	        assertTrue(warningButton.isDisplayed(), "delete button should be visible.");
	     }
	}
