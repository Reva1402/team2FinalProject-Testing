...
class userViewprofile {
    ...
    @Test
    void testEditButton() {
        WebElement editButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div/div/div/div/button[1]")));
        assertNotNull(editButton, "Edit button should be visible");
        editButton.click();
    }
