...
public class DeleteEventTesting {
    ...
    public void loginAndNavigateToMyEvents() {
        ...
        emailField.sendKeys("rachnaaulakh@gmail.com");  // Replace with test email
    ...
    public void testDeleteConfirmationMessage() throws InterruptedException {
        WebElement deleteButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(text(), 'Delete')]")));
