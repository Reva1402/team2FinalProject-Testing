...
public class moderatoreventmanagement {
	 ...
	 private WebDriver driver;
	    ...
	    public void setUp() throws InterruptedException {
	        ...
	        WebElement profilelink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/aside/a[4]")));
	        profilelink.click();
	    }
	    @Test
	    public void testprofiledashboardnavbar() throws InterruptedException {
	        ...
	        assertNotEquals("Admin one", profilehead.getText());
	    }
	    @Test
	    ...
	    @Test
	    public void testviewButtonIsClickable() {
	        
	        WebElement vieewButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div/table/tbody/tr[1]/td[5]/button[1]")));
	        assertTrue("view button should be clickable", vieewButton.isEnabled());
	    }
	    @Test
	    public void testsuspendButtonIsClickable() {
	        
	        WebElement susspendButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div/table/tbody/tr[1]/td[5]/button[2]")));
	        assertTrue("suspend button should be clickable", susspendButton.isEnabled());
	    }
