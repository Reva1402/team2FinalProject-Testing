...
public class DeleteUserAccount {
    ...
    public void setUp() {
        ...
        WebElement userManagementLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div/div/aside/a[2]")));
        userManagementLink.click();

        
        wait.until(ExpectedConditions.urlToBe("http://localhost:3000/users"));
    }
    ...
    public void testDeleteUserAccount() {
        ...
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/div/div/div[2]/table/tbody/tr[1]/td[4]/button[4]")));
        deleteButton.click();
        ...
        assertTrue("First alert text does not match expected message", alertText.contains("Are you sure you want to delete this user?"));
        ...
        assertTrue("Second alert text does not match expected message", successAlertText.contains("User deleted successfully!"));
    	...
    	@Test
    	public void testDeleteUserAccountCancel() {
    	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    	    ...
    	    assertTrue("Alert text does not match expected message", alertText.contains("Are you sure you want to delete this user?"));

    	    alert.dismiss();

    	    WebElement userRow = driver.findElement(By.xpath("/html/body/div/div/div/div[2]/table/tbody"));
    	    assertNotNull("User row should still exist", userRow);
    	}
    
    @Test
    public void testDeleteRandomUserAndCheckRowCount() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        ...
        assertTrue("No users found to delete", rowCountBefore > 0);

        
        int randomRow = (int) (Math.random() * rowCountBefore) + 1; 
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("/html/body/div/div/div/div[2]/table/tbody/tr[1]/td[4]/button[4]" + randomRow + "]/td[2]/button[3]")));
        deleteButton.click();
        ...
        List<WebElement> rowsAfter = driver.findElements(By.xpath("/html/body/div/div/div/div/main/div/table/tbody/tr"));
        int rowCountAfter = rowsAfter.size();

        
        assertTrue("Row count did not decrease after deleting a user", rowCountAfter < rowCountBefore);

        System.out.println("User deleted successfully. Row count before: " + rowCountBefore + ", Row count after: " + rowCountAfter);
    }
